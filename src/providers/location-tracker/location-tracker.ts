...
import { BackgroundGeolocation, BackgroundGeolocationLocationProvider, BackgroundGeolocationAccuracy, BackgroundGeolocationEvents, ServiceStatus, BackgroundGeolocationResponse } from '@ionic-native/background-geolocation';
