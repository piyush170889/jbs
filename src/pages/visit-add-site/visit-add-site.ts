...
import { IonicPage, NavController, NavParams, ViewController, AlertController, Modal, ModalController } from 'ionic-angular';
import { PlaceaddressPage } from "../placeaddress/placeaddress";
